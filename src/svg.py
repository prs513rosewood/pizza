...
class svg:
    ...
    def transform(self, obj, matrix):
        ...
        if obj[0] == 0:                      # transform atom
            ...
            onew.append(matrix[0]*obj[8] + matrix[3]
                        * obj[9] + matrix[6]*obj[10])
            onew.append(matrix[1]*obj[8] + matrix[4]
                        * obj[9] + matrix[7]*obj[10])
            onew.append(matrix[2]*obj[8] + matrix[5]
                        * obj[9] + matrix[8]*obj[10])
